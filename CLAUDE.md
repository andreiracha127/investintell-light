...
---
## investintell_light_skills

**investintell-light-research** — location /mnt/skills/user/investintell-light-research/SKILL.md — "Use this skill to perform comprehensive research and analysis on financial markets, companies, and economic indicators. This includes fetching real-time stock data, historical financial statements, news sentiment, analyst ratings, and macroeconomic data. Trigger this skill when the user asks for investment advice, market analysis, company valuations, or any query requiring deep financial insights. Do NOT use for simple factual lookups that web_search can handle, or for personal financial advice. This skill is designed for detailed, data-driven financial research."
