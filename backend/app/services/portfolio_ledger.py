...
async def seed_initial_position_buys(
    ...
    ``positions`` is the current snapshot; ``portfolio_transactions`` is the
    auditable source for transaction-aware NAV. Manual portfolio creation writes
    the snapshot first, then calls this helper before committing.
    """
